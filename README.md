...
The first milestone is to build a custom low-level driver layer for the STM32H7Sxx microcontroller family. After the driver layer is stable, the project will evolve into a real-time telemetry dashboard that receives telemetry data from a PC and displays warnings and driving information using the STM32 board.
